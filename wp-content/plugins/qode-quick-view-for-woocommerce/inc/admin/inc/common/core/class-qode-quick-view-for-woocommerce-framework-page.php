...
abstract class Qode_Quick_View_For_WooCommerce_Framework_Page implements Qode_Quick_View_For_WooCommerce_Framework_Tree_Interface {
	private $scope;
	private $type;
	private $slug;
	private $layout;
	...
	public function render() {
		...
		$params['class']      .= ' qodef-page-v4-quick-view';

		if ( $this->get_layout() === 'tabbed' ) {
			wp_enqueue_script( 'jquery-ui-tabs' );
		}

		qode_quick_view_for_woocommerce_framework_template_part( QODE_QUICK_VIEW_FOR_WOOCOMMERCE_ADMIN_PATH, 'inc/common', 'templates/page', $this->get_layout(), $params );
	}
}
