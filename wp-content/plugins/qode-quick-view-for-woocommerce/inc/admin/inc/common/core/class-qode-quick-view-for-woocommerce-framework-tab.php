...
abstract class Qode_Quick_View_For_WooCommerce_Framework_Tab implements Qode_Quick_View_For_WooCommerce_Framework_Tree_Interface, Qode_Quick_View_For_WooCommerce_Framework_Child_Interface {
	private $scope;
	private $type;
	private $name;
	private $title;
	...
	public function render() {
		...
		qode_quick_view_for_woocommerce_framework_template_part( QODE_QUICK_VIEW_FOR_WOOCOMMERCE_ADMIN_PATH, 'inc/common', 'templates/tab', '', $params );
	}
}
