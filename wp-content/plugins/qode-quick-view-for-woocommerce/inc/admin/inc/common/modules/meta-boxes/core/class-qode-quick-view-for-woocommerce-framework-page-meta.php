...
class Qode_Quick_View_For_WooCommerce_Framework_Page_Meta extends Qode_Quick_View_For_WooCommerce_Framework_Page {

	public function add_tab_element( $params ) {
		if ( isset( $params['name'] ) && ! empty( $params['name'] ) ) {
			$params['type'] = 'front-end';
			$field          = new Qode_Quick_View_For_WooCommerce_Framework_Tab_Meta( $params );
	...
	public function add_repeater_element( $params ) {
		...
		qode_quick_view_for_woocommerce_framework_get_framework_root()->get_meta_options()->set_option( $params['name'], '', 'repeater' );
