...
?>
<div id="qode-quick-view-for-woocommerce-deactivation-modal">
		...
		<div class="qodef-deactivation-modal-content">
			...
			<div class="qodef-deactivation-modal-header">
				<h2 class="qodef-deactivation-modal-title">
					<?php esc_html_e( 'Quick Feedback', 'qode-quick-view-for-woocommerce' ); ?>
				</h2>
			</div>
			<form class="qodef-deactivation-modal-form" method="post">
				<div class="qodef-deactivation-modal-form-caption">
					<p>
						...
						printf(
							...
							esc_html__( 'If you have a moment, please share why you are deactivating %s:', 'qode-quick-view-for-woocommerce' ),
					...
					<div class="qodef-deactivation-modal-form-option">
						...
						<div class="qodef-deactivation-modal-form-option-text">
							...
							printf(
								...
								esc_html__( 'Wait! Don\'t deactivate %1$s. You have to activate both %2$s and %3$s Premium in order for the plugin to work.', 'qode-quick-view-for-woocommerce' ),
								esc_html( $plugin_name ),
								esc_html( $plugin_name ),
								esc_html( $plugin_name )
							);
				...
				<div class="qodef-deactivation-modal-form-buttons">
					<button class="qodef-deactivation-modal-button qodef-deactivation-modal-button-submit qodef-btn qodef-btn-solid" ><?php esc_html_e( 'Submit & Deactivate', 'qode-quick-view-for-woocommerce' ); ?></button>
					<button class="qodef-deactivation-modal-button qodef-deactivation-modal-button-skip qodef-btn qodef-btn-simple"><?php esc_html_e( 'Skip & Deactivate', 'qode-quick-view-for-woocommerce' ); ?></button>
				</div>
				<?php wp_nonce_field( 'qode-quick-view-for-woocommerce-deactivation-nonce', 'qode-quick-view-for-woocommerce-deactivation-nonce' ); ?>
			</form>
		</div>
	</div>
</div>
