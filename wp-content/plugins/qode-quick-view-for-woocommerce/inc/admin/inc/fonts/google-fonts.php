...
if ( ! function_exists( 'qode_quick_view_for_woocommerce_framework_get_google_fonts_json' ) ) {
	/**
	 ...
	 */
	function qode_quick_view_for_woocommerce_framework_get_google_fonts_json() {
