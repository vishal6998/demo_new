...
/**
 * Class LaurentInstagramHelper
 */
class LaurentInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines laurent_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image ) {
		...
		$imageAtts = apply_filters( 'laurent_instagram_image_atts',
			array(
