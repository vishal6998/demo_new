...
include 'laurent-instagram-helper.php';

/**
 * Class LaurentInstagramApi
 */
class LaurentInstagramApi {
    ...
    const INSTAGRAM_CODE = 'laurent_instagram_code';
    const INSTAGRAM_USER_ID = 'laurent_instagram_user_id';
    const INSTAGRAM_TOKEN = 'laurent_instagram_access_token';
    const INSTAGRAM_TOKEN_LONG_LIVED = 'laurent_instagram_access_token_long_lived';
    const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'laurent_instagram_access_token_long_lived_time';

    const FACEBOOK_CODE = 'laurent_facebook_code';
    const FACEBOOK_TOKEN = 'laurent_facebook_access_token';

    const CONNECTION_TYPE = 'laurent_connection_type';
    ...
    public function __construct() {
        ...
        $this->helper = new LaurentInstagramHelper();
    }

    /**
     * @return LaurentInstagramApi
     */
     ...
     *
     * @see LaurentInstagramApi::fetchData()
     */
     ...
     * @return stdClass
     *
     * @see LaurentInstagramApi::instagramExchangeCodeForToken()
     */
