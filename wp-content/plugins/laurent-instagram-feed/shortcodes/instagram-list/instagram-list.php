...
namespace LaurentInstagram\Shortcodes\InstagramList;

use LaurentInstagram\Lib;
...
class InstagramList implements Lib\ShortcodeInterface
{
    ...
    public function vcMap()
    {
        if (function_exists('vc_map')) {
            vc_map(
                array(
                    'name' => esc_html__('Elated Instagram List', 'laurent-instagram-feed'),
                    'base' => $this->base,
                    'category' => esc_html__('by LAURENT', 'laurent-instagram-feed'),
                    ...
                    'params' => array(
                        array(
                            ...
                            'heading' => esc_html__('Number of Columns', 'laurent-instagram-feed'),
                            'value' => array_flip(laurent_elated_get_number_of_columns_array(false, array('one', 'six'))),
                            'save_always' => true
                        ),
                        array(
                            'param_name' => 'type',
                            'type' => 'dropdown',
                            'heading' => esc_html__('Type', 'laurent-instagram-feed'),
                            'value' => array(
                                esc_html__( 'Gallery', 'laurent-instagram-feed') => 'gallery',
                                esc_html__( 'Carousel', 'laurent-instagram-feed') => 'carousel'
                            )
                        ),
                        array(
                            'param_name' => 'space_between_columns',
                            'type' => 'dropdown',
                            'heading' => esc_html__('Space Between Items', 'laurent-instagram-feed'),
                            'value' => array_flip(laurent_elated_get_space_between_items_array())
                        ),
                        array(
                            'type' => 'textfield',
                            'param_name' => 'number_of_photos',
                            'heading' => esc_html__('Number of Photos', 'laurent-instagram-feed')
                        ),
                        array(
                            'type' => 'textfield',
                            'param_name' => 'transient_time',
                            'heading' => esc_html__('Images Cache Time', 'laurent-instagram-feed'),
	                        'value' => '10800',
	                        'save_always' => true,
                        ),
                        ...
                        array(
                            ...
                            'type' => 'dropdown',
                            'heading' => esc_html__('Show Instagram Icon', 'laurent-instagram-feed'),
                            'value' => array_flip(laurent_elated_get_yes_no_select_array(false)),
                        ),
                        array(
                            'type' => 'dropdown',
                            'param_name' => 'slider_loop',
                            'heading' => esc_html__('Enable Slider Loop', 'laurent-instagram-feed'),
                            'value' => array_flip(laurent_elated_get_yes_no_select_array(false, true)),
                            'save_always' => true,
                            'group' => esc_html__('Slider Settings', 'laurent-instagram-feed')
                        ),
                        array(
                            'type' => 'dropdown',
                            'param_name' => 'slider_autoplay',
                            'heading' => esc_html__('Enable Slider Autoplay', 'laurent-instagram-feed'),
                            'value' => array_flip(laurent_elated_get_yes_no_select_array(false, true)),
                            'save_always' => true,
                            'group' => esc_html__('Slider Settings', 'laurent-instagram-feed')
                        ),
                        array(
                            ...
                            'heading' => esc_html__('Slide Duration', 'laurent-instagram-feed'),
                        ...
                        array(
                            ...
                            'heading' => esc_html__('Slide Animation Duration', 'laurent-instagram-feed'),
                        ...
                        array(
                            ...
                            'heading' => esc_html__('Enable Slider Navigation Arrows', 'laurent-instagram-feed'),
                            'value' => array_flip(laurent_elated_get_yes_no_select_array(false, true)),
                            'save_always' => true,
                            'group' => esc_html__('Slider Settings', 'laurent-instagram-feed')
                        ),
                        array(
                            ...
                            'heading' => esc_html__('Enable Slider Pagination', 'laurent-instagram-feed'),
    ...
    public function render($atts, $content = null)
    {
        ...
        $html = laurent_instagram_get_shortcode_module_template_part('templates/holder', 'instagram-list', '', $params);
