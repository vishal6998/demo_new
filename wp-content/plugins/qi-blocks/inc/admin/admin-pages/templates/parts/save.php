...
?>
<div class="qodef-save-<?php echo esc_attr( $page_slug ); ?>-holder">
	<div class="qodef-save-success">
		<p class="qodef-field-description">
			<?php esc_html_e( 'Successfully saved!', 'qi-blocks' ); ?>
		</p>
	</div>
	...
	<button class="qodef-btn qodef-btn-outlined"><?php esc_html_e( 'Save', 'qi-blocks' ); ?></button>
	<?php wp_nonce_field( 'qi_blocks_' . esc_attr( $nonce_slug ) . '_save_nonce', 'qi_blocks_' . esc_attr( $nonce_slug ) . '_save_nonce' ); ?>
</div>
