...
?>
<div id="qode-wishlist-for-woocommerce-deactivation-modal">
		...
		<div class="qodef-deactivation-modal-content">
			...
			<div class="qodef-deactivation-modal-header">
				<h2 class="qodef-deactivation-modal-title">
					<?php esc_html_e( 'Quick Feedback', 'qode-wishlist-for-woocommerce' ); ?>
				</h2>
			</div>
				...
				<div class="qodef-deactivation-modal-form-options">
					<div class="qodef-deactivation-modal-form-option">
						...
						<label for="qodef-deactivation-modal-form-option-no_longer_needed" class="qodef-deactivation-modal-form-option-label">
							...
							<span class="qodef-label-text">
								<?php esc_html_e( 'I no longer need the plugin', 'qode-wishlist-for-woocommerce' ); ?>
							</span>
						</label>
					</div>
					<div class="qodef-deactivation-modal-form-option">
						...
						<label for="qodef-deactivation-modal-form-option-found_a_better_plugin" class="qodef-deactivation-modal-form-option-label">
							<span class="qodef-label-view"></span>
							<span class="qodef-label-text">
								<?php esc_html_e( 'I found a better plugin', 'qode-wishlist-for-woocommerce' ); ?>
							</span>
						</label>
						<input type="text" class="qodef-deactivation-modal-form-option-text" name="reason_found_a_better_plugin" placeholder="<?php esc_attr_e( 'Please share which plugin', 'qode-wishlist-for-woocommerce' ); ?>">
					</div>
					<div class="qodef-deactivation-modal-form-option">
						...
						<label for="qodef-deactivation-modal-form-option-couldnt_get_plugin_to_work" class="qodef-deactivation-modal-form-option-label">
							<span class="qodef-label-view"></span>
							<span class="qodef-label-text">
								<?php esc_html_e( 'I couldn\'t get plugin to work', 'qode-wishlist-for-woocommerce' ); ?>
							</span>
						</label>
					</div>
					<div class="qodef-deactivation-modal-form-option">
						...
						<label for="qodef-deactivation-modal-form-option-temporary_deactivation" class="qodef-deactivation-modal-form-option-label">
							<span class="qodef-label-view"></span>
							<span class="qodef-label-text">
								<?php esc_html_e( 'This is a temporary deactivation', 'qode-wishlist-for-woocommerce' ); ?>
							</span>
						</label>
					</div>
					<div class="qodef-deactivation-modal-form-option">
					...
					<div class="qodef-deactivation-modal-form-option">
						...
						<label for="qodef-deactivation-modal-form-option-other" class="qodef-deactivation-modal-form-option-label">
							<span class="qodef-label-view"></span>
							<span class="qodef-label-text">
								<?php esc_html_e( 'Other', 'qode-wishlist-for-woocommerce' ); ?>
							</span>
						</label>
						<input type="text" class="qodef-deactivation-modal-form-option-text" name="reason_other" placeholder="<?php esc_attr_e( 'Please share the reason', 'qode-wishlist-for-woocommerce' ); ?>">
					</div>
				</div>
				<div class="qodef-deactivation-modal-form-buttons">
					<button class="qodef-deactivation-modal-button qodef-deactivation-modal-button-submit qodef-btn qodef-btn-solid" ><?php esc_html_e( 'Submit & Deactivate', 'qode-wishlist-for-woocommerce' ); ?></button>
					<button class="qodef-deactivation-modal-button qodef-deactivation-modal-button-skip qodef-btn qodef-btn-simple"><?php esc_html_e( 'Skip & Deactivate', 'qode-wishlist-for-woocommerce' ); ?></button>
				</div>
				<?php wp_nonce_field( 'qode-wishlist-for-woocommerce-deactivation-nonce', 'qode-wishlist-for-woocommerce-deactivation-nonce' ); ?>
			</form>
		</div>
	</div>
</div>
