...
class Qode_Wishlist_For_WooCommerce_Framework_Page_Admin extends Qode_Wishlist_For_WooCommerce_Framework_Page {

	public function add_tab_element( $params ) {
		if ( isset( $params['name'] ) && ! empty( $params['name'] ) ) {
			$params['type']  = 'admin';
			$params['scope'] = $this->get_scope();
			$field           = new Qode_Wishlist_For_WooCommerce_Framework_Tab_Admin( $params );
