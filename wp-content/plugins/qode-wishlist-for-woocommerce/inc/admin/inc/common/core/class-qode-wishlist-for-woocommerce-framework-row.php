...
abstract class Qode_Wishlist_For_WooCommerce_Framework_Row implements Qode_Wishlist_For_WooCommerce_Framework_Tree_Interface, Qode_Wishlist_For_WooCommerce_Framework_Child_Interface {
	...
	public function render() {
		...
		qode_wishlist_for_woocommerce_framework_template_part( QODE_WISHLIST_FOR_WOOCOMMERCE_ADMIN_PATH, 'inc/common', 'templates/row', $this->layout, $params );
	}
}
