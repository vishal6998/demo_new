...
if ( ! function_exists( 'qode_wishlist_for_woocommerce_framework_get_google_fonts_json' ) ) {
	/**
	 ...
	 */
	function qode_wishlist_for_woocommerce_framework_get_google_fonts_json() {
