...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Project Info', 'laurent-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'laurent-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
						...
						array(
							...
							'heading'     => esc_html__( 'Project Info Type', 'laurent-core' ),
							'value'       => array(
								esc_html__( 'Title', 'laurent-core' )          => 'title',
								esc_html__( 'Category', 'laurent-core' )       => 'category',
								esc_html__( 'Tag', 'laurent-core' )            => 'tag',
								esc_html__( 'Author', 'laurent-core' )         => 'author',
								esc_html__( 'Date', 'laurent-core' )           => 'date',
								esc_html__( 'Featured Image', 'laurent-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Project Title Tag', 'laurent-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Project Info Label', 'laurent-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Project Info Label Tag', 'laurent-core' ),
							'value'      => array_flip( laurent_elated_get_title_tag( true, array( 'p' => 'p' ) ) ),
