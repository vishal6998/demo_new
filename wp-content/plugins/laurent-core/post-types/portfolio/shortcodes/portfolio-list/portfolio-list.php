...
class PortfolioList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map( array(
					'name'     => esc_html__( 'Portfolio List', 'laurent-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Portfolio List Template', 'laurent-core' ),
							'value'       => array(
								esc_html__( 'Gallery', 'laurent-core' ) => 'gallery',
						...
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Per Page', 'laurent-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Fixed Image Proportions', 'laurent-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Pagination Type', 'laurent-core' ),
							'value'      => array(
								esc_html__( 'None', 'laurent-core' )            => 'no-pagination',
								esc_html__( 'Standard', 'laurent-core' )        => 'standard',
								esc_html__( 'Load More', 'laurent-core' )       => 'load-more',
								esc_html__( 'Infinite Scroll', 'laurent-core' ) => 'infinite-scroll'
							),
							'group'      => esc_html__( 'Additional Features', 'laurent-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'load_more_top_margin',
							'heading'    => esc_html__( 'Load More Top Margin (px or %)', 'laurent-core' ),
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'filter',
							'heading'    => esc_html__( 'Enable Category Filter', 'laurent-core' ),
							'value'      => array_flip( laurent_elated_get_yes_no_select_array( false ) ),
							'group'      => esc_html__( 'Additional Features', 'laurent-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Order By', 'laurent-core' ),
							'value'      => array(
								esc_html__( 'Name', 'laurent-core' )  => 'name',
								esc_html__( 'Count', 'laurent-core' ) => 'count',
								esc_html__( 'Id', 'laurent-core' )    => 'id',
								esc_html__( 'Slug', 'laurent-core' )  => 'slug'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Filter Text Transform', 'laurent-core' ),
							'value'      => array_flip( laurent_elated_get_text_transform_array( true ) ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'laurent-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Bottom Margin (px or %)', 'laurent-core' ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'laurent-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Enable Article Animation', 'laurent-core' ),
							'value'       => array_flip( laurent_elated_get_yes_no_select_array( false ) ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = laurent_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-list', 'portfolio-holder', $params['type'], $params, $additional_params );
