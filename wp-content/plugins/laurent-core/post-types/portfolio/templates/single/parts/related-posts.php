...
$show_related_posts = laurent_elated_options()->getOptionValue('portfolio_single_related_posts') == 'yes';

$post_id = get_the_ID();
$related_posts = laurent_core_get_portfolio_single_related_posts($post_id);
?>
