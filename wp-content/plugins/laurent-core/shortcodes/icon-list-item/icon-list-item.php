<?php
namespace LaurentCore\CPT\Shortcodes\IconListItem;
...
class IconListItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Icon List Item', 'laurent-core' ),
					'base'     => $this->base,
					...
					'params'   => array_merge(
						array(
							...
							array(
								...
								'heading'     => esc_html__( 'Icon List Item Bottom Margin (px)', 'laurent-core' ),
						...
						array(
							array(
								...
								'heading'    => esc_html__( 'Icon Size (px)', 'laurent-core' )
							),
							array(
								'type'       => 'colorpicker',
							...
							array(
								...
								'heading'    => esc_html__( 'Title Size (px)', 'laurent-core' ),
							...
							array(
								...
								'heading'     => esc_html__( 'Title Left Padding (px)', 'laurent-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$args   = array_merge( $args, laurent_elated_icon_collections()->getShortcodeParams() );
		...
		$html = laurent_core_get_shortcode_module_template_part( 'templates/icon-list-item-template', 'icon-list-item', '', $params );
