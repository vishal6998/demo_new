<?php
namespace LaurentCore\CPT\Shortcodes\Separator;
...
class Separator implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Separator', 'laurent-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Normal', 'laurent-core' )     => 'normal',
								esc_html__( 'Full Width', 'laurent-core' ) => 'full-width'
							)
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Dashed', 'laurent-core' )  => 'dashed',
								esc_html__( 'Solid', 'laurent-core' )   => 'solid',
								esc_html__( 'Dotted', 'laurent-core' )  => 'dotted'
							),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'width',
							'heading'    => esc_html__( 'Width (px or %)', 'laurent-core' ),
							'dependency' => array( 'element' => 'type', 'value' => array( 'normal' ) )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'thickness',
							'heading'    => esc_html__( 'Thickness (px)', 'laurent-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'top_margin',
							'heading'    => esc_html__( 'Top Margin (px or %)', 'laurent-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'bottom_margin',
							'heading'    => esc_html__( 'Bottom Margin (px or %)', 'laurent-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = laurent_core_get_shortcode_module_template_part( 'templates/separator-template', 'separator', '', $params );
