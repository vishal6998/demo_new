<?php
namespace LaurentCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Call To Action', 'laurent-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'laurent-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'laurent-core' ),
							'value'      => array(
								esc_html__( '80/20', 'laurent-core' ) => '80',
								esc_html__( '75/25', 'laurent-core' ) => '75',
								esc_html__( '66/33', 'laurent-core' ) => '66',
								esc_html__( '50/50', 'laurent-core' ) => '50'
							),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'normal' ) )
						),
						array(
						...
						array(
							...
							'heading'     => esc_html__( 'Button Type', 'laurent-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Button Size', 'laurent-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Background Color', 'laurent-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Hover Background Color', 'laurent-core' ),
							'group'      => esc_html__( 'Button Style', 'laurent-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_border_color',
							'heading'    => esc_html__( 'Button Border Color', 'laurent-core' ),
							'group'      => esc_html__( 'Button Style', 'laurent-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_border_color',
							'heading'    => esc_html__( 'Button Hover Border Color', 'laurent-core' ),
							'group'      => esc_html__( 'Button Style', 'laurent-core' )
						),
						array(
							'type'       => 'textarea_html',
							'param_name' => 'content',
							'heading'    => esc_html__( 'Content', 'laurent-core' ),
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'laurent-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = laurent_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
