...
class LaurentCoreElementorSingleImage extends \Elementor\Widget_Base {
	...
	public function render() {
		...
		$params['ornament_svg_path']  = isset($params['ornament_svg_path']) ? base64_encode( urlencode( $params['ornament_svg_path'] )) : '';
...
\Elementor\Plugin::instance()->widgets_manager->register( new LaurentCoreElementorSingleImage() );