<?php
namespace LaurentCore\CPT\Shortcodes\Banner;
...
class Banner implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Banner', 'laurent-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Image Overlay Color', 'laurent-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'hover_behavior',
							'heading'     => esc_html__( 'Hover Behavior', 'laurent-core' ),
							'value'       => array(
								esc_html__( 'Visible on Hover', 'laurent-core' )   => 'eltdf-visible-on-hover',
								esc_html__( 'Visible on Default', 'laurent-core' ) => 'eltdf-visible-on-default',
								esc_html__( 'Disabled', 'laurent-core' )           => 'eltdf-disabled'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Info Position', 'laurent-core' ),
							'value'       => array(
								esc_html__( 'Default', 'laurent-core' )  => 'default',
								esc_html__( 'Centered', 'laurent-core' ) => 'centered'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Info Content Padding', 'laurent-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left', 'laurent-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'subtitle',
							'heading'    => esc_html__( 'Subtitle', 'laurent-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'subtitle_tag',
							'heading'     => esc_html__( 'Subtitle Tag', 'laurent-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Subtitle Color', 'laurent-core' ),
							'dependency' => array( 'element' => 'subtitle', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'     => esc_html__( 'Words with Light Font Weight', 'laurent-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Link Text', 'laurent-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'link_color',
							'heading'    => esc_html__( 'Link Text Color', 'laurent-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'link_top_margin',
							'heading'    => esc_html__( 'Link Text Top Margin (px)', 'laurent-core' ),
							'dependency' => array( 'element' => 'link', 'not_empty' => true )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = laurent_core_get_shortcode_module_template_part( 'templates/banner', 'banner', '', $params );
