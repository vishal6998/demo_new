...
class PricingTableItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Pricing Table Item', 'laurent-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Set Item As Active', 'laurent-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Background Color', 'laurent-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'title',
							'heading'     => esc_html__( 'Title', 'laurent-core' ),
							'value'       => esc_html__( 'Basic Plan', 'laurent-core' ),
							'save_always' => true
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'heading'    => esc_html__( 'Title Bottom Border Color', 'laurent-core' ),
							'dependency' => array( 'element' => 'title', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'value'       => esc_html__( 'BUY NOW', 'laurent-core' ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		$html = laurent_core_get_shortcode_module_template_part( 'templates/pricing-table-template', 'pricing-table', '', $params );
