<?php
namespace LaurentCore\CPT\Shortcodes\ClientsCarousel;
...
class ClientsCarousel implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Clients Carousel', 'laurent-core' ),
					'base'            => $this->getBase(),
					...
					'params'          => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Items Hover Animation', 'laurent-core' ),
							'value'       => array(
								esc_html__( 'Switch Images', 'laurent-core' ) => 'switch-images',
								esc_html__( 'Roll Over', 'laurent-core' )     => 'roll-over'
							),
							'save_always' => true
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = laurent_core_get_shortcode_module_template_part( 'templates/clients-carousel', 'clients-carousel', '', $params );
