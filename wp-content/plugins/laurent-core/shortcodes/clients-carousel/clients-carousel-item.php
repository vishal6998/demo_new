<?php
namespace LaurentCore\CPT\Shortcodes\ClientsCarouselItem;
...
class ClientsCarouselItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Clients Item', 'laurent-core' ),
					'base'                    => $this->getBase(),
					...
					'params'                  => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Hover Image', 'laurent-core' ),
							'description' => esc_html__( 'Select image from media library', 'laurent-core' )
						),
						array(
							'type'        => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		$html = laurent_core_get_shortcode_module_template_part( 'templates/clients-carousel-item', 'clients-carousel', '', $params );
