<?php
namespace LaurentCore\CPT\Shortcodes\Button;
...
class Button implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Button', 'laurent-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array_merge(
						array(
							...
							array(
								...
								'value'       => array(
                                    ...
                                    esc_html__( 'Special', 'laurent-core' ) => 'special'
								),
								'admin_label' => true
							),
							array(
							...
							array(
								...
								'value'       => esc_html__( 'Button Text', 'laurent-core' ),
								'save_always' => true,
								'admin_label' => true
							),
							array(
						...
						laurent_elated_icon_collections()->getVCParamsArray( array(), '', true ),
						array(
							array(
								'type'       => 'colorpicker',
								'param_name' => 'color',
								'heading'    => esc_html__( 'Color', 'laurent-core' ),
								'group'      => esc_html__( 'Design Options', 'laurent-core' )
							),
							array(
								'type'       => 'colorpicker',
								'param_name' => 'hover_color',
								'heading'    => esc_html__( 'Hover Color', 'laurent-core' ),
								'group'      => esc_html__( 'Design Options', 'laurent-core' )
							),
							array(
								'type'       => 'colorpicker',
							...
							array(
								...
								'heading'    => esc_html__( 'Font Size (px)', 'laurent-core' ),
								'group'      => esc_html__( 'Design Options', 'laurent-core' )
							),
							array(
								'type'        => 'dropdown',
							...
							array(
								'type'        => 'textfield',
								'param_name'  => 'padding',
								'heading'     => esc_html__( 'Button Padding', 'laurent-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		return laurent_core_get_shortcode_module_template_part( 'templates/' . $params['html_type'], 'button', '', $params );
	}
