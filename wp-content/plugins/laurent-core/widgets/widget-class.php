 ...
 *
 * Class LaurentCoreClassWidget
 */
abstract class LaurentCoreClassWidget extends WP_Widget {
    /**
        ...
        if(is_array($this->params) && count($this->params)) {
            ...
            foreach($this->params as $param) {
                switch($param['type']) {
	                ...
	                case 'image': ?>
		                <div class="eltdf-user-image-field">
			                <label for="<?php echo esc_attr($this->get_field_id($param['name'])); ?>"><?php echo esc_html($param['title']); ?>:</label>
			                <input type="hidden" name="<?php echo esc_attr($this->get_field_name($param['name'])); ?>" id="<?php echo esc_attr($this->get_field_id($param['name'])); ?>" class="widefat eltdf-user-custom-media-url" value="<?php echo esc_attr(${$param['name']}); ?>">
			                ...
			                <p>
				                ...
				                <input type="button" class="button button-secondary eltdf-user-media-remove" name="eltdf-user-media-remove" value="<?php esc_attr_e( 'Remove Image', 'laurent' ); ?>"/>
			                </p>
		                </div>
		                <?php
		                break;
            ...
            <p><?php esc_html_e('There are no options for this widget.', 'laurent-core'); ?></p>
        <?php }
    }
