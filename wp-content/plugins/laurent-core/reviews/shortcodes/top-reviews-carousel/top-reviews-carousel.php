...
namespace LaurentCore\CPT\Shortcodes\TopReviewsCarousel;

use LaurentCore\Lib\ShortcodeInterface;

class TopReviewsCarousel implements ShortcodeInterface {
	private $base;
	
	public function __construct() {
		$this->base = 'laurent_core_top_reviews_carousel';
	...
	public function vcMap() {
		$criteria_ratings = laurent_core_rating_criteria_for_vc();
		
		vc_map(
			array(
				'name'                      => esc_html__( 'Top Reviews Carousel', 'laurent-core' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					...
					array(
						...
						'heading'     => esc_html__( 'Number of Reviews', 'laurent-core' ),
						'description' => esc_html__( 'Leave empty for all', 'laurent-core' )
					),
					array(
						'type'        => 'dropdown',
						'param_name'  => 'review_criteria',
						'heading'     => esc_html__( 'Order by Review Criteria', 'laurent-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		return laurent_core_get_module_shortcode_template_part( 'reviews', 'top-reviews-carousel', 'top-reviews-carousel', '', $params );
	}
