...
if ( ! class_exists( 'LaurentCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class LaurentCoreDashboardRestAPI {
		...
		public function __construct() {
			...
			add_filter( 'laurent_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	LaurentCoreDashboardRestAPI::get_instance();
}