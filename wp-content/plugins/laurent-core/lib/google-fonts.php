<?php
if ( ! function_exists( 'laurent_elated_init_google_fonts_array' ) ) {
    function laurent_elated_init_google_fonts_array() {
...
';
        ...
        $laurent_elated_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'laurent_elated_init_google_fonts_array');
}