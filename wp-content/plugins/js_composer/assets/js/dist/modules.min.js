...
jQuery(document).ready(function(e){function c(t){var t=e(t.currentTarget),o=t.attr("data-post-custom-layout"),a=e("#wpb_wpbakery");a&&(t=e("#vc_ui-panel-post-settings .vc_post-custom-layout[data-post-custom-layout="+o+"]"),a.find(".vc_navbar").addClass("vc_post-custom-layout-selected"),a.find(".metabox-composer-content").addClass("vc_post-custom-layout-selected")),s(o,t)}function s(t,o=!1){(o=o||e(".vc_post-custom-layout[data-post-custom-layout="+t+"]")).addClass("vc-active-post-custom-layout"),o.siblings().removeClass("vc-active-post-custom-layout"),e("input[name=vc_post_custom_layout]").val(t)}e(".vc_post-custom-layout").on("click",c),e("#vc_ui-panel-post-settings .vc_post-custom-layout").on("click",function(t){var t=e(t.currentTarget).attr("data-post-custom-layout"),o="default"===t?"blank":"default",a=window.vc.page_settings_editor||{};a.custom_layout={currentValue:t,previousValue:o},window.vc.page_settings_editor=a}).on("click",function(t){var o,a;"admin_frontend_editor"===window.vc_mode&&(t.preventDefault(),o=new URL(window.location.href),(a=o.searchParams).delete("vc_post_custom_layout"),window.history.replaceState({},"",o.origin+o.pathname+"?"+a.toString()),c(t))}),e(document).on("wpbPageSettingRoleBack",function(t){t.detail.custom_layout&&s(t.detail.custom_layout.currentValue)})});
(()=>{function e(){var e,o,n=window.vc.latestAddedElement;n&&n.view&&n.view.el&&(n=n.view.el.getBoundingClientRect().top,e=document.getElementById("vc_inline-frame"),o=n+(window.scrollY||document.documentElement.scrollTop)-250,(e?(o=n+((n=e.contentWindow).scrollY||n.document.documentElement.scrollTop)-250,n):window).scrollTo({top:o,behavior:"smooth"}))}var o=!window.vc_modules.hasOwnProperty("vc-scroll-to-element")||window.vc_modules["vc-scroll-to-element"],n="admin_frontend_editor"===window.vc_mode;o&&(n?vc.events.once("shortcodeView:ready",function(){vc.events.on("afterLoadShortcode",_.debounce(e,300))}):vc.events.on("shortcodeView:ready",_.debounce(e,300)))})();
["wpbAceEditorContentChanged","wpbPageSettingRoleBack"].forEach(function(e){document.addEventListener(e,function(e){var t;vc.frame_window&&(e.detail.wpb_js_header_editor&&(t=e.detail.wpb_js_header_editor.currentValue,vc.frame_window.vc_iframe.loadCustomJsHeader(t)),e.detail.wpb_js_footer_editor)&&(t=e.detail.wpb_js_footer_editor.currentValue,vc.frame_window.vc_iframe.loadCustomJsFooter(t))})});
["wpbAceEditorContentChanged","wpbPageSettingRoleBack"].forEach(function(e){document.addEventListener(e,function(e){e.detail.wpb_css_editor&&(e=e.detail.wpb_css_editor.currentValue,vc.frame_window)&&vc.frame_window.vc_iframe.loadCustomCss(e)})});