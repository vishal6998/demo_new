...
(t=>{new function(){t(".gallery_widget_attached_images_list",this.$view).off("click.removeImage").on("click.removeImage","a.vc_icon-remove",function(e){e.preventDefault();var e=t(this).closest(".edit_form_line"),a=(t(this).parent().remove(),[]);e.find(".added img").each(function(){a.push(t(this).attr("rel"))}),e.find(".gallery_widget_attached_images_ids").val(a.join(",")).trigger("change")}),t(".gallery_widget_attached_images_list").each(function(){var a=t(this);a.sortable({forcePlaceholderSize:!0,placeholder:"widgets-placeholder-gallery",cursor:"move",items:"li",update:function(){var e=[];t(this).find(".added img").each(function(){e.push(t(this).attr("rel"))}),a.closest(".edit_form_line").find(".gallery_widget_attached_images_ids").val(e.join(",")).trigger("change")}})})};var i=t("#vc_edit-form-tabs");i.length&&(t(".wpb-edit-form").addClass("vc_with-tabs"),i.find(".vc_edit-form-tab-control").removeClass("vc_active").eq(0).addClass("vc_active"),i.find('[data-vc-ui-element="panel-edit-element-tab"]').removeClass("vc_active").eq(0).addClass("vc_active"),i.find(".vc_edit-form-link").on("click",function(e){var a=t(this);e.preventDefault(),i.find(".vc_active").removeClass("vc_active"),a.parent().addClass("vc_active"),t(a.attr("href")).addClass("vc_active").parents(".vc_panel-body").scrollTop(0)}))})(window.jQuery);
