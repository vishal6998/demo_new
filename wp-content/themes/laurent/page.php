...
$eltdf_grid_space_meta = laurent_elated_get_meta_field_intersect( 'page_grid_space' );
...
<div class="eltdf-container eltdf-default-page-template">
	...
	<div class="eltdf-container-inner clearfix">
		...
		<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
			<div class="eltdf-grid-row <?php echo esc_attr( $eltdf_holder_classes ); ?>">
				<div <?php echo laurent_elated_get_content_sidebar_class(); ?>>
					<?php
						the_content();
						do_action( 'laurent_elated_action_page_after_content' );
					?>
				</div>
		...
		<?php endwhile; endif; ?>
        <?php do_action( 'laurent_elated_action_before_container_inner_close' ); ?>
	</div>
