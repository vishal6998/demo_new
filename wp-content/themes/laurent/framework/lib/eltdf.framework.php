...
/*
   Class: LaurentElatedClassFramework
...
class LaurentElatedClassFramework {
	...
	public $eltdDashboardOptions;
	private $skin;
	
	private function __construct() {
		$this->eltdOptions         = LaurentElatedClassOptions::get_instance();
		$this->eltdMetaBoxes       = LaurentElatedClassMetaBoxes::get_instance();
		$this->eltdTaxonomyOptions = LaurentElatedClassTaxonomyOptions::get_instance();
		$this->eltdUserOptions     = LaurentElatedClassUserOptions::get_instance();
		$this->eltdDashboardOptions = LaurentElatedClassDashboardOptions::get_instance();
	}
	...
	public function setSkin( LaurentElatedClassSkinAbstract $skinObject ) {
		$this->skin = $skinObject;
	}
}

/**
 * Class LaurentElatedClassSkinManager
 *
...
class LaurentElatedClassSkinManager {
	...
	/**
	 * @see LaurentElatedClassSkinManager::setSkin()
	 */
	 ...
	 */
	private function setSkin( $skinName = LAURENT_ELATED_PROFILE_SLUG ) {
		if ( $skinName !== '' ) {
...
/**
 * Class LaurentElatedClassSkinAbstract
 *
 * Abstract class that each skin class must extend
 */
abstract class LaurentElatedClassSkinAbstract {
	/**
	 * @var string
	 */
	protected $skinName;
	...
	public function loadTemplatePart( $template, $params = array() ) {
		...
		if ( $template !== '' ) {
			include( laurent_elated_find_template_path( 'framework/admin/skins/' . $this->skinName . '/templates/' . $template . '.php' ) );
		}
	}
	...
	public function setShortcodeJSParams() { ?>
		<script>
			window.eltdSCIcon = '<?php echo laurent_elated_get_skin_uri() . '/assets/img/admin-logo-icon.png'; ?>';
			window.eltdSCLabel = '<?php echo esc_html( ucfirst( $this->skinName ) ); ?> <?php esc_html_e( 'Shortcodes', 'laurent' ) ?>';
		</script>
	<?php }
...
/*
   Class: LaurentElatedClassOptions
...
class LaurentElatedClassOptions {
	...
	public function getOptionValue( $key ) {
		...
		if ( array_key_exists( $key, $laurent_elated_global_options ) ) {
			return $laurent_elated_global_options[ $key ];
...
/*
   Class: LaurentElatedClassAdminPage
   A class that initializes Elated Admin Page
*/
class LaurentElatedClassAdminPage implements iLaurentElatedInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $slug;
	public $title;
	...
	function __construct( $slug = "", $title = "", $icon = "" ) {
		$this->layout  = array();
		$this->factory = new LaurentElatedClassFieldFactory();
		$this->slug    = $slug;
		$this->title   = $title;
		$this->icon    = $icon;
	}
	...
	public function renderChild( iLaurentElatedInterfaceRender $child ) {
		$child->render( $this->factory );
	}
}

/*
   Class: LaurentElatedClassMetaBoxes
...
/*
   Class: LaurentElatedClassMetaBox
   A class that initializes Elated Meta Box
*/
class LaurentElatedClassMetaBox implements iLaurentElatedInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	public $title;
	...
	public function setTitle( $label ) {
		...
		return $laurent_elated_global_Framework->getSkin()->getSkinLabel() . ' ' . $label;
	}
}

/*
   Class: LaurentElatedClassTaxonomyOptions
   A class that initializes LaurentElatedClass Taxonomy Options
*/
class LaurentElatedClassTaxonomyOptions {
	private static $instance;
...
/*
   Class: LaurentElatedClassTaxonomyOption
   A class that initializes LaurentElatedClass Taxonomy Option
*/
class LaurentElatedClassTaxonomyOption implements iLaurentElatedInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	...
	function __construct( $scope = "" ) {
		$this->layout  = array();
		$this->factory = new LaurentElatedClassTaxonomyFieldFactory();
		$this->scope   = $scope;
	}
...
/*
   Class: LaurentElatedClassUserOptions
   A class that initializes LaurentElatedClass User Options
*/
class LaurentElatedClassUserOptions {
	private static $instance;
	public $userOptions;
...
/*
   Class: LaurentElatedClassUserOption
   A class that initializes LaurentElatedClass User Option
*/
class LaurentElatedClassUserOption implements iLaurentElatedInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	...
	function __construct( $scope = "" ) {
		$this->layout  = array();
		$this->factory = new LaurentElatedClassUserFieldFactory();
		$this->scope   = $scope;
	}
...
/*
   Class: LaurentElatedClassDashboardOptions
   A class that initializes LaurentElatedClass Dashboard Options
*/
class LaurentElatedClassDashboardOptions {
	private static $instance;
...
/*
   Class: LaurentElatedClassDashboardOption
   A class that initializes LaurentElatedClass Dashboard Option
*/
class LaurentElatedClassDashboardOption implements iLaurentElatedInterfaceLayoutNode {
	public $layout;
	private $factory;
	
	function __construct() {
		$this->layout        = array();
		$this->factory       = new LaurentElatedClassDashboardFieldFactory();
	}
...
if ( ! function_exists( 'laurent_elated_init_framework_variable' ) ) {
	function laurent_elated_init_framework_variable() {
		global $laurent_elated_global_Framework;
		
		$laurent_elated_global_Framework = LaurentElatedClassFramework::get_instance();
		$eltdSkinManager                 = new LaurentElatedClassSkinManager();
		$laurent_elated_global_Framework->setSkin( $eltdSkinManager->getSkin() );
	}
	
	add_action( 'laurent_elated_action_before_options_map', 'laurent_elated_init_framework_variable' );
}
?>