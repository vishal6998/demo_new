...
if ( ! function_exists( 'laurent_elated_add_font_awesome_icon_pack' ) ) {
	function laurent_elated_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new LaurentElatedClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'laurent_elated_filter_add_icon_pack_into_collection', 'laurent_elated_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'laurent_elated_add_font_awesome_icon_pack_option' ) ) {
	function laurent_elated_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'laurent' );
		
		return $options;
	}
	
	add_filter( 'laurent_elated_filter_add_icon_pack_into_options', 'laurent_elated_add_font_awesome_icon_pack_option' );
	add_filter( 'laurent_elated_filter_add_icon_pack_into_social_options', 'laurent_elated_add_font_awesome_icon_pack_option' );
}

class LaurentElatedClassIconsFontAwesome implements iLaurentElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $socialIcons;
	public $param;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = LAURENT_ELATED_FRAMEWORK_ICONS_ROOT . '/font-awesome/css/fontawesome-all.min.css';
	}
	...
	private function getNewIconsArray( $brandsIcons = false ) {
		...
		$iconsArray = array();
		$icons      = json_decode( $wp_filesystem->get_contents( LAURENT_ELATED_FRAMEWORK_ICONS_ROOT_DIR . '/font-awesome/icons.json' ) );
