...
if ( ! function_exists( 'laurent_elated_add_ion_icon_pack' ) ) {
	function laurent_elated_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new LaurentElatedClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'laurent_elated_filter_add_icon_pack_into_collection', 'laurent_elated_add_ion_icon_pack' );
}

if ( ! function_exists( 'laurent_elated_add_ion_icon_pack_option' ) ) {
	function laurent_elated_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'laurent' );
		
		return $options;
	}
	
	add_filter( 'laurent_elated_filter_add_icon_pack_into_options', 'laurent_elated_add_ion_icon_pack_option' );
	add_filter( 'laurent_elated_filter_add_icon_pack_into_social_options', 'laurent_elated_add_ion_icon_pack_option' );
}

class LaurentElatedClassIonIcons implements iLaurentElatedInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = LAURENT_ELATED_FRAMEWORK_ICONS_ROOT . '/ion-icons/css/ionicons.min.css';
	}
