...
if ( ! function_exists( 'laurent_elated_add_simple_line_icon_pack' ) ) {
	function laurent_elated_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new LaurentElatedClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'laurent_elated_filter_add_icon_pack_into_collection', 'laurent_elated_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'laurent_elated_add_simple_line_icon_pack_option' ) ) {
	function laurent_elated_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'laurent' );
		
		return $options;
	}
	
	add_filter( 'laurent_elated_filter_add_icon_pack_into_options', 'laurent_elated_add_simple_line_icon_pack_option' );
	add_filter( 'laurent_elated_filter_add_icon_pack_into_social_options', 'laurent_elated_add_simple_line_icon_pack_option' );
}

class LaurentElatedClassSimpleLineIcons implements iLaurentElatedInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->styleUrl = LAURENT_ELATED_FRAMEWORK_ICONS_ROOT . '/simple-line-icons/simple-line-icons.css';
    }
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'laurent'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'laurent'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'laurent'),
            'icon-social-facebook'    => esc_html__('Facebook', 'laurent'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'laurent'),
            'icon-social-github'      => esc_html__('Github', 'laurent'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'laurent'),
            'icon-social-instagram'   => esc_html__('Instagram', 'laurent'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'laurent'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'laurent'),
            'icon-social-reddit'      => esc_html__('Reddit', 'laurent'),
            'icon-social-skype'       => esc_html__('Skype', 'laurent'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'laurent'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'laurent'),
            'icon-social-spotify'     => esc_html__('Spotify', 'laurent'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'laurent'),
            'icon-social-twitter'     => esc_html__('Twitter', 'laurent'),
            'icon-social-youtube'     => esc_html__('Youtube', 'laurent')
        );
    }
