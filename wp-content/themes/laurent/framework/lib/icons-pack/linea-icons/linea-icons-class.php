...
if ( ! function_exists( 'laurent_elated_add_linea_icon_pack' ) ) {
	function laurent_elated_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new LaurentElatedClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'laurent_elated_filter_add_icon_pack_into_collection', 'laurent_elated_add_linea_icon_pack' );
}

if ( ! function_exists( 'laurent_elated_add_linea_icon_pack_option' ) ) {
	function laurent_elated_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'laurent' );
		
		return $options;
	}
	
	add_filter( 'laurent_elated_filter_add_icon_pack_into_options', 'laurent_elated_add_linea_icon_pack_option' );
}

class LaurentElatedClassLineaIcons implements iLaurentElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	public function __construct($title = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = LAURENT_ELATED_FRAMEWORK_ICONS_ROOT . '/linea-icons/style.css';
	}
