...
if ( ! function_exists( 'laurent_elated_add_font_elegant_icon_pack' ) ) {
	function laurent_elated_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new LaurentElatedClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'laurent_elated_filter_add_icon_pack_into_collection', 'laurent_elated_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'laurent_elated_add_font_elegant_icon_pack_option' ) ) {
	function laurent_elated_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'laurent' );
		
		return $options;
	}
	
	add_filter( 'laurent_elated_filter_add_icon_pack_into_options', 'laurent_elated_add_font_elegant_icon_pack_option' );
	add_filter( 'laurent_elated_filter_add_icon_pack_into_social_options', 'laurent_elated_add_font_elegant_icon_pack_option' );
}

class LaurentElatedClassIconsFontElegant implements iLaurentElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $socialIcons;
	public $param;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = LAURENT_ELATED_FRAMEWORK_ICONS_ROOT . '/elegant-icons/style.min.css';
	}
