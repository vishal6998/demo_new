...
if ( ! function_exists( 'laurent_elated_add_linear_icon_pack' ) ) {
	function laurent_elated_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new LaurentElatedClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'laurent_elated_filter_add_icon_pack_into_collection', 'laurent_elated_add_linear_icon_pack' );
}

if ( ! function_exists( 'laurent_elated_add_linear_icon_pack_option' ) ) {
	function laurent_elated_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'laurent' );
		
		return $options;
	}
	
	add_filter( 'laurent_elated_filter_add_icon_pack_into_options', 'laurent_elated_add_linear_icon_pack_option' );
}

class LaurentElatedClassLinearIcons implements iLaurentElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = LAURENT_ELATED_FRAMEWORK_ICONS_ROOT . '/linear-icons/style.css';
	}
