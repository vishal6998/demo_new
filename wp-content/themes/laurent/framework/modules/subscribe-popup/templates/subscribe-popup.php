        ...
        <div class="eltdf-sp-table-cell">
            <div class="eltdf-sp-inner">
	            ...
	            <?php if ( ! empty( $background_styles ) ) { ?>
		            <div class="eltdf-sp-background" <?php laurent_elated_inline_style( $background_styles ); ?>></div>
	            <?php } ?>
	                ...
	                <?php if ( $enable_prevent === 'yes' ) { ?>
		                <div class="eltdf-sp-prevent">
			                <div class="eltdf-sp-prevent-inner">
				                ...
				                <label class="eltdf-sp-prevent-label"><?php esc_html_e( 'Prevent This Pop-up', 'laurent' ); ?></label>
			                </div>
		                </div>
	                <?php } ?>
                </div>
