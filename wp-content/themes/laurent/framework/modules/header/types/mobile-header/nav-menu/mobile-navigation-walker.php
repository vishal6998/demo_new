...
if (!class_exists('LaurentElatedClassMobileNavigationWalker')) {
	class LaurentElatedClassMobileNavigationWalker extends Walker_Nav_Menu {
			...
			if($item->hide == ""){
				...
				if($args->has_children) {
					$item_output .= '<span class="mobile_arrow">' .
                                    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8.3 8.5" class="eltdf-menu-arrow">' .
