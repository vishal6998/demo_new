<?php do_action('laurent_elated_action_before_sticky_header'); ?>
...
<div class="eltdf-sticky-header">
                ...
                <div class="eltdf-position-left"><!--
                 --><div class="eltdf-position-left-inner">
                        ...
                        <?php if($menu_area_position === 'left') : ?>
                            <?php laurent_elated_get_sticky_menu('eltdf-sticky-nav'); ?>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="eltdf-position-right"><!--
                 --><div class="eltdf-position-right-inner">
                        <?php if($menu_area_position === 'right') : ?>
                            <?php laurent_elated_get_sticky_menu('eltdf-sticky-nav'); ?>
                        <?php endif; ?>
                        <?php laurent_elated_get_sticky_header_widget_menu_area(); ?>
                    </div>
                </div>
            </div>
            <?php if($sticky_header_in_grid) : ?>
	...
	<?php do_action( 'laurent_elated_action_before_sticky_menu_html_close' ); ?>
</div>
