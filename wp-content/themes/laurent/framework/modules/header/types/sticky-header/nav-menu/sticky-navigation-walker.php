...
if (!class_exists('LaurentElatedClassStickyNavigationWalker')) {
	class LaurentElatedClassStickyNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
                ...
                if($args->has_children && $depth == 1) {
                    $item_output .= '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8.3 8.5" class="eltdf-menu-arrow">' .
