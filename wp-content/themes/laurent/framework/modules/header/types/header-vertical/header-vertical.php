...
class HeaderVertical extends HeaderType {
	...
	public function loadTemplate( $parameters = array() ) {
		$parameters['holder_class'] = laurent_elated_vertical_header_holder_class();
		
		$parameters = apply_filters( 'laurent_elated_filter_header_vertical_parameters', $parameters );
