...
if ( ! function_exists('laurent_elated_contact_form_7_options_map') ) {

	function laurent_elated_contact_form_7_options_map() {
		
		laurent_elated_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'laurent' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = laurent_elated_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'laurent' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = laurent_elated_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'laurent' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'laurent' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = laurent_elated_add_admin_row(
			array(
		...
		laurent_elated_add_admin_field(array(
			...
			'default_value' => '',
			'label'         => esc_html__( 'Placeholder Text Color', 'laurent' ),
		));
		...
		laurent_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'laurent' ),
			)
		);
		...
		$typography_text_row2 = laurent_elated_add_admin_row(
			array(
		...
		$typography_text_row3 = laurent_elated_add_admin_row(
			array(
		...
		$typography_label_group = laurent_elated_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'laurent' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'laurent' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = laurent_elated_add_admin_row(
			array(
		...
		$typography_label_row2 = laurent_elated_add_admin_row(
			array(
		...
		$background_border_group = laurent_elated_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'laurent' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'laurent' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = laurent_elated_add_admin_row(
			array(
		...
		laurent_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'laurent' )
			)
		);
		...
		laurent_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'laurent' )
			)
		);
		
		$background_border_row2 = laurent_elated_add_admin_row(
			array(
		...
		laurent_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'laurent' ),
			)
		);
		...
		laurent_elated_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'laurent' )
			)
		);
		...
		laurent_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'laurent' )
			)
		);
		
		$background_border_row3 = laurent_elated_add_admin_row(
			array(
		...
		laurent_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'laurent' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = laurent_elated_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'laurent' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = laurent_elated_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		laurent_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'laurent' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		laurent_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'laurent' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		laurent_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'laurent' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		laurent_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'laurent' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = laurent_elated_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'laurent' ),
				'description' => esc_html__( 'Setup form elements margin', 'laurent' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = laurent_elated_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		laurent_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top', 'laurent' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		laurent_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom', 'laurent' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		laurent_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'laurent' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'laurent' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = laurent_elated_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'laurent' ),
				'description' => esc_html__( 'Setup button text typography', 'laurent' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = laurent_elated_add_admin_row(
			array(
		...
		$button_typography_row2 = laurent_elated_add_admin_row(
			array(
		...
		$button_background_border_group = laurent_elated_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'laurent' ),
				'description' => esc_html__( 'Setup button background and border style', 'laurent' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = laurent_elated_add_admin_row(
			array(
		...
		laurent_elated_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'laurent' )
			)
		);
		...
		laurent_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'laurent' )
			)
		);
		
		$button_background_border_row2 = laurent_elated_add_admin_row(
			array(
		...
		laurent_elated_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'laurent' )
			)
		);
		...
		laurent_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'laurent' )
			)
		);
		
		$button_background_border_row3 = laurent_elated_add_admin_row(
			array(
		...
		laurent_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'laurent' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		laurent_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'laurent' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = laurent_elated_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'laurent')
		));

		//Text Typography

		$typography_text_group = laurent_elated_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'laurent'),
			'description'	=> esc_html__('Setup typography for form elements text', 'laurent'),
		...
		$typography_text_row1 = laurent_elated_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = laurent_elated_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = laurent_elated_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = laurent_elated_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'laurent'),
			'description'	=> esc_html__('Setup typography for form elements label', 'laurent'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = laurent_elated_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = laurent_elated_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = laurent_elated_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'laurent'),
			'description'	=> esc_html__('Setup form elements background and border style', 'laurent'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = laurent_elated_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = laurent_elated_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = laurent_elated_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = laurent_elated_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'laurent'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = laurent_elated_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = laurent_elated_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'laurent'),
			'description'	=> esc_html__('Setup form elements margin', 'laurent'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = laurent_elated_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = laurent_elated_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'laurent'),
			'description'	=> esc_html__('Setup button text typography', 'laurent'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = laurent_elated_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = laurent_elated_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = laurent_elated_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'laurent'),
			'description'	=> esc_html__('Setup button background and border style', 'laurent'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = laurent_elated_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = laurent_elated_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = laurent_elated_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = laurent_elated_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'laurent')
        ));
        ...
        $typography_label_row3 = laurent_elated_add_admin_row(array(
        ...
        $button_typography_row3 = laurent_elated_add_admin_row(array(
	...
	add_action( 'laurent_elated_action_options_map', 'laurent_elated_contact_form_7_options_map', laurent_elated_set_options_map_position( 'contact_form_7' ) );
}