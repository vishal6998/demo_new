...
if ( class_exists( 'LaurentCoreClassWidget' ) ) {
	class LaurentElatedClassSearchPostType extends LaurentCoreClassWidget {
		public function __construct() {
			parent::__construct(
				'eltdf_search_post_type',
				esc_html__( 'Laurent Search Post Type', 'laurent' ),
				array( 'description' => esc_html__( 'Select post type that you want to be searched for', 'laurent' ) )
			);
		...
		public function widget( $args, $instance ) {
			...
			<div class="widget eltdf-search-post-type-widget">
				<div data-post-type="<?php echo esc_attr( $post_type ); ?>" <?php laurent_elated_class_attribute( $search_type_class ); ?>>
					<input class="eltdf-post-type-search-field" value="" placeholder="<?php esc_attr_e( 'Search here', 'laurent' ) ?>">
