<?php
namespace LaurentCore\CPT\Shortcodes\BlogList;
...
class BlogList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog List', 'laurent' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							...
							esc_html__( 'Boxed', 'laurent' )    => 'boxed',
							esc_html__( 'Simple', 'laurent' )   => 'simple',
							esc_html__( 'Minimal', 'laurent' )  => 'minimal'
						),
						'save_always' => true
					),
					array(
						...
						'heading'    => esc_html__( 'Number of Posts', 'laurent' )
					),
					array(
						'type'       => 'dropdown',
					...
					array(
						...
						'value'      => array(
							...
							esc_html__( 'Thumbnail', 'laurent' ) => 'thumbnail',
							esc_html__( 'Medium', 'laurent' )    => 'medium',
							esc_html__( 'Large', 'laurent' )     => 'large',
							esc_html__( 'Custom', 'laurent' )    => 'custom'
						),
						'save_always' => true,
						'dependency'  => Array( 'element' => 'type', 'value' => array( 'standard', 'boxed' ) )
					),
					array(
						...
						'heading'     => esc_html__( 'Custom Image Width', 'laurent' ),
					...
					array(
						...
						'heading'     => esc_html__( 'Custom Image Height', 'laurent' ),
					...
					array(
						...
						'group'      => esc_html__( 'Post Info', 'laurent' )
					),
					array(
						'type'       => 'dropdown',
					...
					array(
						...
						'heading'     => esc_html__( 'Text Length', 'laurent' ),
						'description' => esc_html__( 'Number of words', 'laurent' ),
						'dependency'  => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed', 'simple' ) ),
						'group'       => esc_html__( 'Post Info', 'laurent' )
					),
					array(
						'type'       => 'dropdown',
						'param_name' => 'post_info_image',
						'heading'    => esc_html__( 'Enable Post Info Image', 'laurent' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Section', 'laurent' ),
						'value'      => array_flip( laurent_elated_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed' ) ),
						'group'      => esc_html__( 'Post Info', 'laurent' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Author', 'laurent' ),
						'value'      => array_flip( laurent_elated_get_yes_no_select_array( false, true ) ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Date', 'laurent' ),
						'value'      => array_flip( laurent_elated_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'laurent' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Category', 'laurent' ),
						'value'      => array_flip( laurent_elated_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'laurent' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Comments', 'laurent' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Share', 'laurent' ),
						'value'      => array_flip( laurent_elated_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'laurent' )
					),
					array(
						...
						'heading'    => esc_html__( 'Pagination Type', 'laurent' ),
						'value'      => array(
							esc_html__( 'None', 'laurent' )            => 'no-pagination',
							esc_html__( 'Standard', 'laurent' )        => 'standard-shortcodes',
							esc_html__( 'Load More', 'laurent' )       => 'load-more',
							esc_html__( 'Infinite Scroll', 'laurent' ) => 'infinite-scroll'
						),
						'group'      => esc_html__( 'Additional Features', 'laurent' )
					)
				)
			)
		);
	...
	public function blogCategoryAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				...
				$data['label'] = ( ( strlen( $value['category_title'] ) > 0 ) ? esc_html__( 'Category', 'laurent' ) . ': ' . $value['category_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $category ) ) {
				...
				if ( ! empty( $category_title ) ) {
					$category_title_display = esc_html__( 'Category', 'laurent' ) . ': ' . $category_title;
				}
