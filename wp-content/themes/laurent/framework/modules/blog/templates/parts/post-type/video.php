    ...
    if ( $video_type == 'social_networks' ) {
	    ...
	    <div class="eltdf-self-hosted-video-holder">
		    <div class="eltdf-video-wrap">
			    <video class="eltdf-self-hosted-video" poster="<?php echo esc_attr( $videoimage ); ?>" preload="auto">
				    ...
				    <object width="320" height="240" type="application/x-shockwave-flash" data="<?php echo esc_attr( $flashmedia ); ?>">
					    ...
					    <img itemprop="image" src="<?php echo esc_attr( $videoimage ); ?>" width="1920" height="800" title="<?php esc_attr_e( 'No video playback capabilities', 'laurent' ); ?>" alt="<?php esc_attr_e( 'Video Thumb', 'laurent' ); ?>"/>
				    </object>
			    </video>
		    </div>
	    </div>
