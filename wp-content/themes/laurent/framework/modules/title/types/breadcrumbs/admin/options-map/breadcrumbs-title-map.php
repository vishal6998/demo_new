...
if ( ! function_exists('laurent_elated_breadcrumbs_title_type_options_map') ) {
	function laurent_elated_breadcrumbs_title_type_options_map($panel_typography) {
		
		laurent_elated_add_admin_section_title(
			array(
				'name'   => 'type_section_breadcrumbs',
				'title'  => esc_html__( 'Breadcrumbs', 'laurent' ),
				'parent' => $panel_typography
			)
		);
	
		$group_page_breadcrumbs_styles = laurent_elated_add_admin_group(
			array(
				'name'        => 'group_page_breadcrumbs_styles',
				'title'       => esc_html__( 'Breadcrumbs', 'laurent' ),
				'description' => esc_html__( 'Define styles for page breadcrumbs', 'laurent' ),
				'parent'      => $panel_typography
			)
		);
	
			$row_page_breadcrumbs_styles_1 = laurent_elated_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_2 = laurent_elated_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_3 = laurent_elated_add_admin_row(
				array(
	...
	add_action( 'laurent_elated_action_additional_title_typography_options_map', 'laurent_elated_breadcrumbs_title_type_options_map');
}