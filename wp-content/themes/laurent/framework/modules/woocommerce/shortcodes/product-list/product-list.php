...
namespace LaurentCore\CPT\Shortcodes\ProductList;
...
class ProductList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product List', 'laurent' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Masonry', 'laurent' )  => 'masonry'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Product Info Position', 'laurent' ),
							'value'       => array(
								esc_html__( 'Info On Image Hover', 'laurent' ) => 'info-on-image',
								esc_html__( 'Info Below Image', 'laurent' )    => 'info-below-image'
							),
							'save_always' => true
						),
						array(
						...
						array(
							...
							'heading'     => esc_html__( 'Number of Columns', 'laurent' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Product Info Skin', 'laurent' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Product Info Text Alignment', 'laurent' ),
							'value'      => array(
								esc_html__( 'Default', 'laurent' ) => '',
						...
						array(
							...
							'heading'    => esc_html__( 'Product Info Bottom Margin (px)', 'laurent' ),
							'dependency' => array( 'element' => 'info_position', 'value'   => array( 'info-below-image' ) ),
							'group'      => esc_html__( 'Product Info Style', 'laurent' )
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = laurent_elated_get_woo_shortcode_module_template_part( 'templates/product-list', 'product-list', $params['type'], $params, $additional_params );
