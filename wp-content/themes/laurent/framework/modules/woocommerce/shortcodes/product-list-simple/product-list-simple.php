...
namespace LaurentCore\CPT\Shortcodes\ProductListSimple;
...
class ProductListSimple implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product List - Simple', 'laurent' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						array(
							'type'       => 'dropdown',
							'param_name' => 'type',
							'heading'    => esc_html__( 'Type', 'laurent' ),
							'value'      => array(
								esc_html__( 'Sale', 'laurent' )         => 'sale',
								esc_html__( 'Best Sellers', 'laurent' ) => 'best-sellers',
								esc_html__( 'Featured', 'laurent' )     => 'featured'
							),
							'save_always' => true
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'number',
							'heading'     => esc_html__( 'Number of Products', 'laurent' ),
							'description' => esc_html__( 'Number of products to show (default value is 4)', 'laurent' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'orderby',
							'heading'     => esc_html__( 'Order By', 'laurent' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Order', 'laurent' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Display Title', 'laurent' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Title Text Transform', 'laurent' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Display Rating', 'laurent' ),
							'value'      => array_flip( laurent_elated_get_yes_no_select_array( false, true ) )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'display_price',
							'heading'    => esc_html__( 'Display Price', 'laurent' ),
							'value'      => array_flip( laurent_elated_get_yes_no_select_array( false, true ) )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = laurent_elated_get_woo_shortcode_module_template_part( 'templates/product-list-template', 'product-list-simple', '', $params );
