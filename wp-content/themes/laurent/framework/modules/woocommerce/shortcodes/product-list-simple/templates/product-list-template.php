    ...
    <ul class="eltdf-pls-inner">
            ...
            <li class="eltdf-pls-item">
                <div class="eltdf-pls-image">
                    <a itemprop="url" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
                        <?php laurent_elated_get_module_template_part('templates/parts/image-simple', 'woocommerce', '', $params); ?>
                    </a>    
                </div>
        ...
        <?php endwhile; else: ?>
            <li class="eltdf-pls-messsage">
                <?php laurent_elated_get_module_template_part('templates/parts/no-posts', 'woocommerce', '', $params); ?>
            </li>
        <?php endif;
            wp_reset_postdata();
        ?>
