<?php
namespace LaurentCore\CPT\Shortcodes\ProductInfo;
...
class ProductInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if(function_exists('vc_map')) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product Info', 'laurent' ),
					'base'                      => $this->getBase(),
					'category'                  => esc_html__( 'by LAURENT', 'laurent' ),
					...
					'params'                    => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Product', 'laurent' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
						...
						array(
							...
							'heading'     => esc_html__( 'Product Info Type', 'laurent' ),
							'value'       => array(
								esc_html__( 'Title', 'laurent' )          => 'title',
								esc_html__( 'Featured Image', 'laurent' ) => 'featured_image',
								esc_html__( 'Category', 'laurent' )       => 'category',
								esc_html__( 'Excerpt', 'laurent' )        => 'excerpt',
								esc_html__( 'Price', 'laurent' )          => 'price',
								esc_html__( 'Rating', 'laurent' )         => 'rating',
								esc_html__( 'Add To Cart', 'laurent' )    => 'add_to_cart',
								esc_html__( 'Tag', 'laurent' )            => 'tag',
								esc_html__( 'Author', 'laurent' )         => 'author',
								esc_html__( 'Date', 'laurent' )           => 'date',
							),
							'admin_label' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Product Info Color', 'laurent' ),
							'dependency' => array( 'element' => 'product_info_type', 'value'   => array( 'title', 'category', 'excerpt', 'price', 'rating', 'tag', 'author', 'date' ) ),
							'group'      => esc_html__( 'Product Info Style', 'laurent' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'title_tag',
							'heading'     => esc_html__( 'Title Tag', 'laurent' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Featured Image Proportions', 'laurent' ),
							'value'      => array(
								esc_html__( 'Default', 'laurent' )        => '',
								esc_html__( 'Original', 'laurent' )       => 'full',
								esc_html__( 'Square', 'laurent' )         => 'laurent_elated_image_square',
								esc_html__( 'Landscape', 'laurent' )      => 'laurent_elated_image_landscape',
								esc_html__( 'Portrait', 'laurent' )       => 'laurent_elated_image_portrait',
								esc_html__( 'Medium', 'laurent' )         => 'medium',
								esc_html__( 'Large', 'laurent' )          => 'large',
								esc_html__( 'Shop Single', 'laurent' )    => 'woocommerce_single',
								esc_html__( 'Shop Thumbnail', 'laurent' ) => 'woocommerce_thumbnail'
							),
						...
						array(
							...
							'heading'     => esc_html__( 'Category Tag', 'laurent' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Add To Cart Skin', 'laurent' ),
							'value'      => array(
								esc_html__( 'Default', 'laurent' ) => '',
								esc_html__( 'White', 'laurent' )   => 'white',
								esc_html__( 'Dark', 'laurent' )    => 'dark'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Add To Cart Size', 'laurent' ),
							'value'      => array(
								esc_html__( 'Default', 'laurent' ) => '',
							...
							'dependency' => array( 'element' => 'product_info_type', 'value'   => array( 'laurent' ) ),
							'group'      => esc_html__( 'Product Info Style', 'laurent' )
						)
					)
				)
